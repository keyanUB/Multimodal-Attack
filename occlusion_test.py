...
for d in data:
  ...
  img = tv_helpers.default_loader(img_path)
  image = model.processor_dict["image_processor"](img)
  text = d['text']
  output = model.classify(img, text)
  # print(output)
  ...
  with torch.no_grad():
    output_prime = model.classify(transforms.ToPILImage()(x_prime.cpu()), text)
  ...
  print("The attack information is:")
  print(json_obj)
  print('-' * 50) 
